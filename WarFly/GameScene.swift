...
class GameScene: SKScene {
    ...
    fileprivate func configureUI() {
        scoreBackground.position = CGPoint(x: scoreBackground.size.width + 10, y: self.size.height - scoreBackground.size.height / 2 - 25)
    ...
    fileprivate func spawnPowerUp() {
        ...
        let randomTimeSpawn = Double(arc4random_uniform(11) + 7)
